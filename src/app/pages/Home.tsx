...
import construction from "../../assets/International_Construction.webp";
import hospitality from "../../assets/Dara_Hotel.avif";
import running from "../../assets/Koh-pich-running.webp";
          ...
          <div className="max-w-[1400px] mx-auto px-6 lg:px-20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 lg:gap-8">
              {coreValues.map((value, i) => (
                ...
                >
                  {/* Animated background glow - Reduced brightness */}
                  <motion.div
